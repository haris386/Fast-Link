...
<section className="w-full bg-black py-20 px-6 lg:px-16">
  <div className="max-w-7xl mx-auto flex flex-col gap-6 mt-24">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
      ...
      <div className="lg:col-span-4 bg-[#EA2127] rounded-2xl p-8 flex flex-col justify-end min-h-[300px]">
        ...
        <p className="text-white/90 text-sm leading-relaxed">
          Every FastLink driver has a dynamic performance score that updates
          after each ride. This score ensures transparency, fairness, and the
          best ride experience for passengers.
        </p>
      </div>
      ...
      <div className="lg:col-span-6 relative rounded-2xl overflow-hidden min-h-[300px]">
        ...
        <div className="absolute bottom-6 left-6 right-6 text-white">
          <h3 className={`${bebasNeue.className} text-xl tracking-wide mb-2`}>
            Ride Quality
          </h3>
          <p className="text-white/90 text-sm leading-relaxed max-w-xl">
            Drivers are evaluated on how smoothly and safely they complete each
            trip. This includes maintaining smooth driving without sudden
            brakes or harsh acceleration, providing a comfortable ride with
            steady speed, and keeping the vehicle clean and well-maintained.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="relative rounded-2xl overflow-hidden min-h-[260px]">
        ...
        <div className="absolute bottom-6 left-6 right-6 text-white">
          <h4 className={`${bebasNeue.className} text-xl tracking-wide mb-2`}>
            Passenger Ratings
          </h4>
          <p className="text-white/90 text-sm">
            Passenger ratings at each trip affect the driver’s score based on
      ...
      <div className="relative rounded-2xl overflow-hidden min-h-[260px]">
        ...
        <div className="absolute bottom-6 left-6 right-6 text-white">
          ...
          <p className="text-white/90 text-sm">
            FastLink rewards honesty, enforces fares, and uses tracking for fair
            pricing.
          </p>
        </div>
      </div>
      ...
      <div className="relative rounded-2xl overflow-hidden min-h-[260px]">
        ...
        <div className="absolute bottom-6 left-6 right-6 text-white">
          ...
          <p className="text-white/90 text-sm">
            Drivers are scored on following recommended routes and managing
            traffic efficiently.
          </p>
        </div>
      </div>
